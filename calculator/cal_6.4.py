    ...
    def run_basic_mode(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                print("You have selected: Compare numbers")
                num1 = input("Enter the first number: ")
                num2 = input("Enter the second number: ")
                if num2 == 'last':
                    num2 = self.basic.results[-1]

                self.basic.compare_numbers(num1, num2)
    ...
    def run_scientific_mode(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                num1 = input("Enter the first number: ")
                if num1 == 'last':
                    num1 = self.scientific.results[-1]
                    num1 = float(num1)
                    print(f"Using last result: {num1}")

                num2 = input("Enter the second number: ")
                if num2 == 'last':
                    num2 = self.scientific.results[-1]
                    num2 = float(num2)

                self.scientific.compare_numbers(num1,num2)
