...
class BasicCalculator:
    ...
    def basic_calc(self):
        ...
        print("7. Variable management")
        print("8. Switch calculator mode")
        print("0. Exit")
    ...
    def run_basic_mode(self):
        ...
        while True:
            ...
            if choice == "1":
                ...
                mode = input("\nEnter choice(1-2): ")
                if mode == "1":
                    print("Already in Basic Calculator")
                elif mode == "2":
                    print("Switching to Scientific Calculator...")
                    self.basic.switch_calc(self.scientific)
                    self.run_scientific_mode()
